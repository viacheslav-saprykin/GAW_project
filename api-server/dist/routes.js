...
async function routes(fastify) {
    ...
    fastify.get('/api/genres', {
        ...
        handler: genres_controller_1.getAllGenres
    });
    // Tracks
    fastify.get('/api/tracks', {
        ...
        handler: tracks_controller_1.getAllTracks
    });
    fastify.get('/api/tracks/:slug', {
        ...
        handler: tracks_controller_1.getTrack
    });
    fastify.post('/api/tracks', {
        ...
        handler: tracks_controller_1.addTrack
    });
    fastify.put('/api/tracks/:id', {
        ...
        handler: tracks_controller_1.updateTrackById
    });
    fastify.delete('/api/tracks/:id', {
        ...
        handler: tracks_controller_1.removeTrack
    });
    fastify.post('/api/tracks/delete', {
        ...
        handler: tracks_controller_1.removeTracks
    });
    // Track files
    fastify.post('/api/tracks/:id/upload', {
        ...
        handler: tracks_controller_1.uploadTrackFile
    });
    fastify.delete('/api/tracks/:id/file', {
        ...
        handler: tracks_controller_1.deleteTrackFile
    });
}
